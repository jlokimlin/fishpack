    ...
    contains
        ...
        subroutine cprod(nd, bd, nm1, bm1, nm2, bm2, na, aa, x, yy, m, a, b, c, d, w, y)
            ...
            outer_loop: do
                ...
                !
                !==> GCC 5.3 doesn't support Fortran 2008's exit within if-then-else block yet.
                !
                !
                inner_loop: do exit_counter = 1,1
                    if (m1 <= 0) then
                        if (m2 <= 0) then
                            exit inner_loop
                        end if
        ...
        subroutine prodp(nd, bd, nm1, bm1, nm2, bm2, na, aa, x, y, m, a, b, c, d, u, w)
            ...
            outer_loop: do
                ...
                w(m-2:m-mm) = w(m-2:m-mm) - d(m-2:m-mm)*w(m-1:m-mm+1) - u(m-2:m-mm)*w(m)
